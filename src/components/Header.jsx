...
import navigation from "../contsants/index";
import Button from "./Button";

// for the position of moble navabr background
...
const Header = () => {
  ...
  //   creaing a new useState for the moble application
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="relative 2-2 flex flex-col
            ...
            >
              {navigation.map((item) => (
                ...
                uppercase text-n-1 translate-colors hover:text-color-1 ${
