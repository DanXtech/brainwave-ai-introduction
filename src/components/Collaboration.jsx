...
import { collabApps, collabContent, collabText } from "../contsants"
        ...
        <Section crosses>
            <div className="container lg:flex">
                <div className="max-w-[25rem]">
                    ...
                    {/* Collaboration list content [2] */}
                    <ul className="max-w-[22rem] mb-10 mt-12 md:mb-14">
                        {collabContent.map((item) => (
                            <li className="mb-3 py-3" key={item}>
                                ...
                                {item.text && (
                                    <p className="body-2 mt-3 text-3 text-n-4">
                                        {item.text}
                                    </p>
                                )}
                            </li>
                    ...
                    rounded-full -translate-x-1/2 scale:75 md:scale-100">
                        ...
                        m-auto border border-n-6 rounded-full">
                            ...
                            p-[0.2rem] bg-conic-gradient rounded-full">
                                <div className="flex items-center
                                justify-center w-full h-full bg-n-8
                                rounded-full">
                        ...
                        {/* for this to work.  for the position of the icon for the circle  design [6] */}
                        <ul>
